...
int main()
{
    ...
    strncpy(namesock.sun_path, (char *)"/run/sdbustest-socket", strlen("/run/sdbustest-socket"));
...
*/
    ...
    strncpy(addr.sun_path, "/home/aeywalee/socket", sizeof(addr.sun_path)-1);
...
//    r = sd_bus_set_address(bus, "unix:path=/run/sdbustest-socket");
//    if (r < 0)
//        throw std::runtime_error(std::to_string(__LINE__) + strerror(-r));
